(()=>{var e={102:()=>{function e(){document.querySelectorAll("#primary-nav .dropdown").forEach((function(e){e.addEventListener("mouseover",(function(){var e=this.querySelector(".dropdown-menu, #primary-nav ul ul");e&&!e.dataset.positionChecked&&(e.getBoundingClientRect().right>(window.innerWidth||document.documentElement.clientWidth)&&e.classList.add("has-submenu-right"),e.dataset.positionChecked="true")}))}))}document.addEventListener("DOMContentLoaded",(function(){var e=document.querySelectorAll(".parallax-container"),t=document.querySelectorAll(".parallax-bg");window.addEventListener("scroll",(function(){var n=window.pageYOffset;t.forEach((function(t,i){var r=e[i].offsetTop;if(n>r-window.innerHeight&&n<r+e[i].offsetHeight){var o=.3*(n-r);t.style.transform="translateY(".concat(o,"px)")}}))}))})),document.addEventListener("DOMContentLoaded",(function(){var e=document.querySelector(".site-header"),t=document.querySelector("#liveToast");if(e&&t){var n=e.offsetHeight+35;t.style.top="".concat(n,"px")}window.addEventListener("resize",(function(){e&&t&&(siteHeaderHeight=e.offsetHeight,topPosition=siteHeaderHeight+35,t.style.top="".concat(topPosition,"px"))}))})),document.addEventListener("DOMContentLoaded",(function(){e(),window.addEventListener("resize",e)})),document.addEventListener("DOMContentLoaded",(function(){var e=document.querySelector("#apxCarousel"),t=e.querySelector(".carousel-inner").querySelectorAll(".carousel-item"),n=e.querySelector(".carousel-indicators");n.innerHTML="",t.forEach((function(e,t){var i=document.createElement("button");i.type="button",i.dataset.bsTarget="#apxCarousel",i.dataset.bsSlideTo=t,i.setAttribute("aria-label","Slide ".concat(t+1)),0===t&&(i.classList.add("active"),i.setAttribute("aria-current","true")),n.appendChild(i)}))})),document.addEventListener("DOMContentLoaded",(function(){document.querySelectorAll('[data-parallax="scroll"]').forEach((function(e){var t=e.getAttribute("data-image-src");if(t){var n=parseFloat(e.getAttribute("data-speed"))||.5;e.style.backgroundImage="url(".concat(t,")"),e.style.backgroundSize="cover",e.style.backgroundPosition="center",window.addEventListener("scroll",(function(){var t=-window.scrollY*n+"px";e.style.backgroundPosition="center ".concat(t)}))}else console.error("Element missing 'data-image-src' attribute.")}))}))},755:function(e,t){var n;
/*!
